...
?>
 ...
 <div class="row" style="margin-bottom: 2%; margin-left: 3%">        
     <div class="col-md-2 col-lg-2" style="width: 29%; " >
            <?php echo '<img src='.$data3->row()->URL. ' alt="blabla" class="img-rounded img-responsive" />';?>
        </div>
        <div class="col-sm-4 col-md-4">
            ...
            <p> <i class="glyphicon glyphicon-tower"></i>&nbsp;&nbsp;Status:&nbsp;&nbsp;<?php echo $row->status; ?>
            ...
            <p> <i class="glyphicon glyphicon-tower"></i>&nbsp;&nbsp;Average rating:&nbsp;&nbsp;
               <?php echo round($row->Ocena, 2); ?>/5<br /><br />
                ...
                <?php echo form_open('frontpage/createRentConsole/' . $row->CID);?>
                <?php 
                $options = array(
                  '1'  => '1',
                  '2'  => '2',
                ...
                ?>
                <br/><br />
                <?php echo form_submit('RentConsole','Rent this Console','class="btn btn-primary btn"');?></p>            
                <?php form_close();?>
        </div>
 </div>